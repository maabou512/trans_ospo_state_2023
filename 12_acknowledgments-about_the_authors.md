# 12. Acknowledgments, About the author
...
> <g id="1">OSPO or OSS initiative funding increases but 2023 concerns have escalated</g>
...
> <g id="1">2022 State of OSPO, Q6 x Q55, sample size = 577</g>
...
> <g id="1">正式な OSPO または OSS イニシアチブを持つ組織は、OSS の上流への強力な貢献者です</g>
...
> <g id="1">さらに、これらの組織の成功を測定するための KPI は、OSPO の主な目的がオープンソース戦略の策定と実行、およびオープンソース プロジェクトとのコラボレーションの改善に焦点を当てていることを示しています。特に、ライセンスコンプライアンスと関連プロセスはわずかに順位が低くなります。私の観点からすると、これはコンプライアンスがもはや重要ではないということを示しているわけではありません。むしろ、ソフトウェア規制への注目が高まっていることを考慮すると、そうではありません。代わりに、組織は OSPO の成熟度モデルに沿って進化しており、基本的なコンプライアンス プロセスを確立した後、OSS に対する戦略的視点に移行しています。</g>
...
> <g id="1">Which technology area does your organization focus its open source activities on? (select all that apply) segmented by: Does your organization have an open source program or initiative</g>
...
> <g id="1">OSPO と OSS イニシアチブの主な課題には、予算の不足、経営幹部のサポートのレベル、組織のポリシー順守などがあります。</g>
...
> <g id="1">組織が OSPO または OSS イニシアティブを持っているかどうかに関係なく、2023 年と 2022 年に OSS プロジェクトに貢献した組織あたりの開発者の平均数</g>
...
> <g id="1">OSPO および OSS 組織との OSS イニシアチブによるコラボレーションは、現在、非常に重要視されています</g>
...
> <g id="1">前述のとおり、<g id="2">欧州公共部門のオープンソースの機会</g> <x id="3"/>(</g><g id="4">https://www.linuxfoundation.org/research/european-public-sector-opportunity</g><g id="5">)、<x id="6"/>バスティアン・ゲリー氏は、フランスの省庁間フリー ソフトウェア カタログ (SILL) にリストされている OSS ソリューションを中心としたマイクロ コミュニティを構築する取り組み。このプラットフォームを使用すると、公共部門内の開発者がつながり、専門知識を交換し、特定のソフトウェア プロジェクトで共同作業できるようになり、知識の共有と交流の文化が促進されます。 「たとえば、PostgreSQL を使用したい場合、少なくとも 10 人の専門家がいることがわかります。目的は専門知識の交換を促進することです。私たちはカタログが人々が交流できる場所として進化するべきだと考えています」とゲリー氏は説明しました。</g>

<g id="1">前述のとおり、<g id="2">欧州公共部門のオープンソースの機会</g> <x id="3"/>(</g><g id="4">https://www.linuxfoundation.org/research/european-public-sector-opportunity</g><g id="5">)、<x id="6"/>バスティアン・ゲリー氏は、フランスの省庁間フリー ソフトウェア カタログ (SILL) にリストされている OSS ソリューションを中心としたマイクロ コミュニティを構築する取り組み。このプラットフォームを使用すると、公共部門内の開発者がつながり、専門知識を交換し、特定のソフトウェア プロジェクトで共同作業できるようになり、知識の共有と交流の文化が促進されます。 「たとえば、PostgreSQL を使用したい場合、少なくとも 10 人の専門家がいることがわかります。目的は専門知識の交換を促進することです。私たちはカタログが人々が交流できる場所として進化するべきだと考えています」とゲリー氏は説明しました。</g>

> P7EA841A1-tu1

> <g id="1">Also mentioned in <g id="2">The European Public Sector Open Source Opportunity</g> </g>

> <g id="1"><g id="2">欧州公共部門のオープンソースの機会</g> </g> でも言及されています

<g id="1"><g id="2">欧州公共部門のオープンソースの機会</g> </g> でも言及されています

> P7EA841A1-tu2

> <g id="1">(</g><g id="2">https://www.linuxfoundation.org/research/european-public-sector-opportunity</g><g id="3">), <x id="4"/>Gijs Hillenius from the EC’s OSPO highlighted the importance of OSPOs within the public sector in removing both legal and organisational barriers against open source adoption by developers, aiding developers in using open source more easily and facilitating collaboration.</g>

> <g id="1">(</g><g id="2">https://www.linuxfoundation.org/research/european-public-sector-opportunity</g><g id="3">)、<x id="4"/>EC の OSPO の Gijs Hillenius 氏は、開発者によるオープンソースの採用に対する法的および組織的障壁の両方を取り除き、開発者によるオープンソースの利用を支援する公共部門内の OSPO の重要性を強調しました。調達がより簡単になり、コラボレーションが促進されます。</g>
...
> <g id="1">Organizations planning to implement an OSPO or OSS initiative see it as a high priority within the next year</g>

> <g id="1">OSPO または OSS イニシアチブの導入を計画している組織は、それが今後 1 年以内の最優先事項であると考えています</g>

<g id="1">OSPO または OSS イニシアチブの導入を計画している組織は、それが今後 1 年以内の最優先事項であると考えています</g>

> P5F908317-tu3

> <g id="1">When does your organization plan to start a program or initiative? (select one)</g>

> <g id="1">あなたの組織はいつプログラムや取り組みを開始する予定ですか? (1 つ選択)</g>

<g id="1">あなたの組織はいつプログラムや取り組みを開始する予定ですか? (1 つ選択)</g>

> NCCC35F01-tu1

> <g id="1">2023 State of OSPOs, Q33, sample size = 46, DKNS responses excluded</g>

> <g id="1">2023 年の OSPO の状況、第 33 四半期、サンプルサイズ = 46、DKNS の回答は除外</g>
...
> <g id="1">OSPOs or OSS initiatives to be implemented will reside at the apex of software development decision making</g>

> <g id="1">実装される OSPO または OSS イニシアチブは、ソフトウェア開発の意思決定の頂点に位置します</g>

<g id="1">実装される OSPO または OSS イニシアチブは、ソフトウェア開発の意思決定の頂点に位置します</g>

> P139ED45E-tu3

> <g id="1">Where will the open source program or initiative be located within the organization? If the effort is informal, answer based on who the primary organizers will report to. (select one)</g>

> <g id="1">オープンソース プログラムまたはイニシアチブは組織内のどこに配置されますか?取り組みが非公式の場合は、主な主催者が誰に報告するかに基づいて回答してください。 (1 つ選択)</g>

<g id="1">オープンソース プログラムまたはイニシアチブは組織内のどこに配置されますか?取り組みが非公式の場合は、主な主催者が誰に報告するかに基づいて回答してください。 (1 つ選択)</g>

> P13A9A009-tu1

> <g id="1">2023 State of OSPOs, Q35, sample size = 46, DKNS responses excluded</g>

> <g id="1">2023 年の OSPO の状況、第 35 四半期、サンプルサイズ = 46、DKNS 回答は除外</g>

<g id="1">2023 年の OSPO の状況、第 35 四半期、サンプルサイズ = 46、DKNS 回答は除外</g>

> P13A9A009-tu2

> <g id="1">2022 State of OSPOs, Q24, sample size = 120, DKNS responses excluded</g>

> <g id="1">2022 年の OSPO の現状、第 24 四半期、サンプルサイズ = 120、DKNS 回答は除外</g>
...
> <g id="1">The leading goals of organizations implementing an OSPO or OSS initiative include: security, innovation, and collaboration</g>

> <g id="1">OSPO または OSS イニシアチブを導入する組織の主な目標には、セキュリティ、イノベーション、コラボレーションが含まれます</g>

<g id="1">OSPO または OSS イニシアチブを導入する組織の主な目標には、セキュリティ、イノベーション、コラボレーションが含まれます</g>

> NEFACE051-tu3

> <g id="1">What does your organization aim to accomplish by starting an open source program? (select all that apply)</g>

> <g id="1">あなたの組織は、オープンソース プログラムを開始することで何を達成することを目指していますか? (該当するものをすべて選択してください)</g>

<g id="1">あなたの組織は、オープンソース プログラムを開始することで何を達成することを目指していますか? (該当するものをすべて選択してください)</g>

> P148B1819-tu1

> <g id="1">2023 State of OSPOs, Q36, sample size = 46, Valid Cases = 46, Total Mentions = 186</g>

> <g id="1">2023 年の OSPO の状況、第 36 四半期、サンプルサイズ = 46、有効なケース = 46、合計言及数 = 186</g>
...
> <g id="1">The leading challenges in implementing an OSPO or OSS initiative include: implementation strategy, exec support, &amp; setting policy</g>

> <g id="1">OSPO または OSS イニシアチブを実装する際の主な課題には、実装戦略、幹部のサポート、および管理が含まれます。ポリシーの設定</g>

<g id="1">OSPO または OSS イニシアチブを実装する際の主な課題には、実装戦略、幹部のサポート、および管理が含まれます。ポリシーの設定</g>

> NF484F4A9-tu3

> <g id="1">What have been the top three biggest challenges in establishing an open source program or initiative? (select up to three responses)</g>

> <g id="1">オープンソース プログラムまたはイニシアチブを確立する際の最大の課題のトップ 3 は何ですか? (回答を 3 つまで選択してください)</g>

<g id="1">オープンソース プログラムまたはイニシアチブを確立する際の最大の課題のトップ 3 は何ですか? (回答を 3 つまで選択してください)</g>

> P1C23C3A3-tu1

> <g id="1">2023 State of OSPOs, Q37, sample size = 46, Valid Cases = 46, Total Mentions = 101</g>

> <g id="1">2023 年の OSPO の状況、第 37 四半期、サンプルサイズ = 46、有効なケース = 46、合計言及数 = 101</g>
...
> <g id="1">Organizations with an OSPO or OSS initiative see it as key to addressing OSS security</g>

> <g id="1">OSPO または OSS イニシアチブを持つ組織は、それが OSS セキュリティに対処するための鍵であると考えています</g>

<g id="1">OSPO または OSS イニシアチブを持つ組織は、それが OSS セキュリティに対処するための鍵であると考えています</g>

> NF84332ED-tu3

> <g id="1">Does your OSPO or similar OSS initiative directly address OSS security issues? (select one) (for organizations who have a formal OSS program or initiative)</g>

> <g id="1">OSPO または同様の OSS イニシアチブは、OSS のセキュリティ問題に直接取り組んでいますか? (1 つ選択) (正式な OSS プログラムまたはイニシアチブを持つ組織の場合)</g>

<g id="1">OSPO または同様の OSS イニシアチブは、OSS のセキュリティ問題に直接取り組んでいますか? (1 つ選択) (正式な OSS プログラムまたはイニシアチブを持つ組織の場合)</g>

> NF410ECCB-tu1

> <g id="1">2023 State of OSPOs, Q50, Filtered by: Q9.1 (org must have a formal OSS program or initiative in place), sample size = 222, DKNS responses excluded</g>

> <g id="1">2023 年の OSPO の現状、Q50、フィルタリング条件: Q9.1 (組織は正式な OSS プログラムまたはイニシアチブを導入している必要がある)、サンプル サイズ = 222、DKNS の回答は除外</g>
...
> <g id="1">OSS license compliance is significantly improved for organizations with a formally structured OSPO or OSS initiative</g>

> <g id="1">正式に構造化された OSPO または OSS イニシアティブを持つ組織の OSS ライセンス コンプライアンスが大幅に向上します</g>

<g id="1">正式に構造化された OSPO または OSS イニシアティブを持つ組織の OSS ライセンス コンプライアンスが大幅に向上します</g>

> P433C3F3F-tu3

> <g id="1">How does your organization check for open source license compliance? (select all that apply) segmented by: <x id="2"/>Does your organization have an open source program or open source initiative? (select one)</g>

> <g id="1">あなたの組織では、オープンソース ライセンスのコンプライアンスをどのようにチェックしていますか? (該当するものをすべて選択してください) セグメント化: <x id="2"/>あなたの組織にはオープンソース プログラムまたはオープンソース イニシアチブがありますか? (1 つ選択)</g>

<g id="1">あなたの組織では、オープンソース ライセンスのコンプライアンスをどのようにチェックしていますか? (該当するものをすべて選択してください) セグメント化: <x id="2"/>あなたの組織にはオープンソース プログラムまたはオープンソース イニシアチブがありますか? (1 つ選択)</g>

> NF86A2D9A-tu1

> <g id="1">2023 State of OSPOs, Q53 x Q9, sample size = 354, Valid Cases = 354, Total Mentions = 555</g>

> <g id="1">2023 年の OSPO の状況、第 53 四半期 x 第 9 四半期、サンプルサイズ = 354、有効なケース = 354、合計言及数 = 555</g>
...
> <g id="1">OSS security is significantly improved for organizations with a formally structured OSPO or OSS initiative</g>

> <g id="1">正式に構造化された OSPO または OSS イニシアチブを持つ組織では、OSS セキュリティが大幅に向上します</g>

<g id="1">正式に構造化された OSPO または OSS イニシアチブを持つ組織では、OSS セキュリティが大幅に向上します</g>

> P46C21F7F-tu3

> <g id="1">How does your organization scan for vulnerabilities and OSS security compliance? (select all that apply) segmented by: Does your organization have an OSS program or initiative? (select one)</g>

> <g id="1">あなたの組織では脆弱性と OSS セキュリティ コンプライアンスをどのようにスキャンしていますか? (該当するものをすべて選択してください) セグメント化: あなたの組織には OSS プログラムまたはイニシアチブがありますか? (1 つ選択)</g>

<g id="1">あなたの組織では脆弱性と OSS セキュリティ コンプライアンスをどのようにスキャンしていますか? (該当するものをすべて選択してください) セグメント化: あなたの組織には OSS プログラムまたはイニシアチブがありますか? (1 つ選択)</g>

> NF94BA5AA-tu1

> <g id="1">2023 State of OSPOs, Q54 x Q9, sample size = 354, Valid Cases = 354, Total Mentions = 554</g>

> <g id="1">2023 年の OSPO の状況、第 54 四半期 x 第 9 四半期、サンプルサイズ = 354、有効なケース = 354、合計言及数 = 554</g>
...
> <g id="1">2023 State of OSPOs and OSS initiatives: survey layout</g>

> <g id="1">2023 年の OSPO と OSS イニシアチブの現状: 調査レイアウト</g>
...
> <g id="1">第 1 四半期～第 8 四半期</g>

<g id="1">第 1 四半期～第 8 四半期</g>

> ND2DB6F77-tu1

> <g id="1">Tell us about yourself and the organization you work for</g>

> <g id="1">あなた自身と働いている組織について教えてください</g>
...
> <g id="1">OSS programs and initiatives</g>

> <g id="1">OSS プログラムと取り組み</g>
...
> <g id="1">Tell us about the OSS program or initiative and its structure</g>

> <g id="1">OSS プログラムまたは取り組みとその構造について教えてください</g>

<g id="1">OSS プログラムまたは取り組みとその構造について教えてください</g>

> ND2DB6F95-tu1

> <g id="1">For orgs with an OSS program (Q9.1-2)</g>

> <g id="1">OSS プログラムを使用する組織の場合 (Q9.1-2)</g>
...
> <g id="1">Tell us about the program or initiative impact</g>

> <g id="1">プログラムまたは取り組みの影響について教えてください</g>
...
> <g id="1">OSS program or initiative sustainability</g>

> <g id="1">OSS プログラムまたは取り組みの持続可能性</g>
...
> <g id="1">OSS program or initiative plans</g>

> <g id="1">OSS プログラムまたはイニシアチブの計画</g>

<g id="1">OSS プログラムまたはイニシアチブの計画</g>

> ND2DB6FB6-tu1

> <g id="1">For orgs planning an OSS program (Q9.3)</g>

> <g id="1">OSS プログラムを計画している組織向け (Q9.3)</g>
...
> <g id="1">Why an OSS program or initiative is not in the plans</g>

> <g id="1">OSS プログラムまたは取り組みが計画に含まれていない理由</g>

<g id="1">OSS プログラムまたは取り組みが計画に含まれていない理由</g>

> ND2DB6FBA-tu1

> <g id="1">For orgs not planning an OSS program (Q9.4)</g>

> <g id="1">OSS プログラムを計画していない組織の場合 (Q9.4)</g>
...
> <g id="1">OSS usage and software practices</g>

> <g id="1">OSS の使用法とソフトウェアの実践</g>
...
> <g id="1">License compliance and security</g>

> <g id="1">ライセンスのコンプライアンスとセキュリティ</g>

<g id="1">ライセンスのコンプライアンスとセキュリティ</g>

> ND2DB6FD7-tu1

> <g id="1">All respondents (except Q50 if no OSS program)</g>

> <g id="1">全回答者 (OSS プログラムがない場合は Q50 を除く)</g>
...
> <g id="1">Name of organization and follow-up</g>

> <g id="1">組織名とフォローアップ</g>
